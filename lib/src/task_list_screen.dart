                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                color: taskController.selectedDate.value.day ==
                                        date.day
                                    ? Colors.white
                                    : Colors.black,
                              ),
...
class ModernTaskList extends StatelessWidget {
  ...
  const ModernTaskList({Key? key, required this.taskController})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: Obx(() {
        final tasks =
            taskController.getTasksForDate(taskController.selectedDate.value);
